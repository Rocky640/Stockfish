...
public:
  ...
  Bitboard discosnipers_and_pinned(Color c) const;
...
private:
  ...
  Bitboard check_discosnipers_and_pinned(Color kingColor) const;
...
inline Bitboard Position::discosnipers_and_pinned(Color c) const {
  return check_discosnipers_and_pinned(c);
}
