...
namespace {
  ...
  const Score CenterBindStop   = S(10, 0);
  ...
  Score evaluate(const Position& pos, Pawns::Entry* e) {
    ...
    if (b) {
       ...
       if (e->semiopenFiles[Us] & shift_bb<Up>CenterBindMask[Us] & theirPawns)
           //the opponent have a pawn in front of our center bind. It can be backward or not.
           //but for sure, it is week.
          score += CenterBindStop;
