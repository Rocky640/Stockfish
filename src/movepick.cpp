...
void MovePicker::score<CAPTURES>() {
  // Winning and equal captures in the main search are ordered by MVV. Surprisingly, 
  // this appears to perform slightly better than SEE-based move ordering: exchanging 
  // big pieces before capturing a hanging piece probably helps to reduce the subtree size.
