...
void MovePicker::score<CAPTURES>() {
  ...
  // captures near our home rank, except for pawns. 
  ...
  for (auto& m : *this)
  {
      Piece pc = pos.piece_on(to_sq(m));
      m.value =  PieceValue[MG][pc]
               - Value(200 * relative_rank(pos.side_to_move(), to_sq(m))) * (pc != PAWN);
  }
}
