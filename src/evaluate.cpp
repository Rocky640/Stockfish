...
namespace {
  ...
  const Score Protector[4][8] = {
    { S( 7, 9), S( 7, 9), S( 7, 1), S( 1, 5), S(-10,-4), S( -1,-4), S( -7,-3), S(-16,-10) }, // Knight
    { S(11, 8), S(11, 8), S(-7,-1), S(-1,-2), S( -1,-7), S(-11,-3), S( -9,-1), S(-16, -1) }, // Bishop
    { S(10, 0), S(10, 0), S(-2, 2), S(-5, 4), S( -6, 2), S(-14,-3), S( -2,-9), S(-12, -7) }, // Rook
    { S( 3,-5), S( 3,-5), S( 2,-5), S(-4, 0), S( -9,-6), S( -4, 7), S(-13,-7), S(-10, -7) }  // Queen
  };
  ...
  Score evaluate_pieces(const Position& pos, EvalInfo& ei, Score* mobility) {
    ...
    while ((s = *pl++) != SQ_NONE)
    {
        ...
        // Bonus for this piece as a king protector based on distance. If the piece defends the 
        // kingRing, divide distance by 2 
        score += Protector[Pt-2][distance(s, pos.square<KING>(Us)) >> !!(b & ei.kingRing[Us])];
