...
namespace {
  ...
  // * NEW * Smooth Rook using formula
  // mg = ln(mob + 1) * 31.622 - 51.304
  // eg = ln(mob + 1) * 95.3   - 80.481
  ...
  //  S( 43,165), S( 49,168), S( 59,169) },
    { S(-51,-80), S(-29,-14), S(-17, 24), S( -7, 52), S(  0, 73), S(  5, 90), // Rooks
      S( 10,105), S( 14,118), S( 18,129), S( 22,139), S( 25,148), S( 27,156),
      S( 30,164), S( 32,171), S( 34,178) },
