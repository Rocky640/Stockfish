...
namespace {
  ...
  #define SS(mg, eg) make_score(mg-9, eg-13)
  ...
  Score evaluate_pieces(const Position& pos, EvalInfo& ei, Score* mobility,
    ...
    while ((s = *pl++) != SQ_NONE)
    {
        ...
        if (Pt == QUEEN)
        {
            // For mobility calculation, exclude squares controlled by opponent pieces,
            // and keep those which are supported by our pieces.
