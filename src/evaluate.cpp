...
namespace {
  ...
  // ThreatByRank[pawn/non-pawn] contains a bonus which will be multiplied by to the relative rank
  // of the threatened piece (from the enemy point of view). For example, if white attacks a Nf3,
  // the relative rank is RANK_6.
