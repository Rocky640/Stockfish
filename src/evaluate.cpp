...
#undef S
  ...
  private:
    ...
    // attacked by a given color and piece type, exlucding x-rays.
  ...
  Score Evaluation<T>::pieces() {
    ...
    while ((s = *pl++) != SQ_NONE)
    {
        ...
        if (bx & kingRing[Them])
        {
            ...
            kingAttacksCount[Us] += popcount(bx & attackedBy[Them][KING]);
        }

        int mob = popcount((Pt == QUEEN ? b : bx) & mobilityArea[Us]);
