...
namespace {
  ...
  Value do_evaluate(const Position& pos) {
    ...
    // Find pawns on rank 5 and above which can move forward
    Bitboard pmobw = shift_bb<DELTA_S>(~pos.pieces()) & ~(Rank2BB | Rank3BB | Rank4BB);
    Bitboard pmobb = shift_bb<DELTA_N>(~pos.pieces()) & ~(Rank7BB | Rank6BB | Rank5BB);
