...
namespace {
  ...
  // * NEW * Smooth Bishop using formula
  // mg = ln(mob+1) * 55.695 - 50.834
  // eg = ln(mob+1) * 57.92 -62.22
  const Score MobilityBonus[][32] = {
    {}, {},
    { S(-75,-76), S(-56,-54), S(- 9,-26), S( -2,-10), S(  6,  5), S( 15, 11), // Knights
      S( 22, 26), S( 30, 28), S( 36, 29) },
    { S(-51,-62), S(-12,-22), S( 10, 1 ), S( 26, 18), S( 39, 31), S( 49, 42), // Bishops
      S( 58, 51), S( 65, 58), S( 72, 65), S( 77, 71), S( 83, 77), S( 88, 82),
      S( 92, 86), S( 96, 91) },
