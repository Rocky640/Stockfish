  ...
  Score Evaluation<T>::pieces() {
    ...
    while ((s = *pl++) != SQ_NONE)
    {
        ...
        if (Pt == BISHOP || Pt == QUEEN)
            attackedBy[Us][ALL_PIECES] |= attacks_bb<BISHOP>(s, pos.pieces(PAWN) | pos.pieces(Them));
        if (Pt == ROOK || Pt == QUEEN)
            attackedBy[Us][ALL_PIECES] |= attacks_bb<ROOK  >(s, pos.pieces(PAWN) | pos.pieces(Them));
