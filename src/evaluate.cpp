...
namespace {
  ...
  Value do_evaluate(const Position& pos) {
    ...
    // Pawns facing a square occupied by a piece, or controlled by 2 opponent pawns, or on ranks 2 and 3.
    // Will be excluded from the mobility area
    Bitboard blockedPawns[] = {
      pos.pieces(WHITE, PAWN) & (shift_bb<DELTA_S>(pos.pieces() | ei.pi->dblp_attacks(BLACK)) | Rank2BB | Rank3BB),
      pos.pieces(BLACK, PAWN) & (shift_bb<DELTA_N>(pos.pieces() | ei.pi->dblp_attacks(WHITE)) | Rank7BB | Rank6BB)
    };
