    ...
    while (b)
    {
        ...
        if (r > RANK_3)
        {
            ...
            if (pos.empty(blockSq))
            {
                ...
                if (!(pos.pieces(Us) & bb))
                    defendedSquares &= attackedBy[Us][ALL_PIECES] | (pos.pieces(Us) ^ pos.pieces(Us, PAWN, KING));

                if (!(pos.pieces(Them) & bb))
                    unsafeSquares &= attackedBy[Them][ALL_PIECES] | pos.pieces(Them) | pos.pieces(Us, PAWN);
