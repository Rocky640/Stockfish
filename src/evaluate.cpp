...
#undef S
  ...
  constexpr int BFmg[RANK_NB][int(FILE_NB) / 2] = {
	  114, 106, 116, 117,
	  102,  97,  99, 105,
	  104, 119, 114, 123,
	  110,  99, 119,  92,
  ...
  constexpr int BFeg[RANK_NB][int(FILE_NB) / 2] = {
	  138, 137, 148, 143,
	  141, 147, 140, 145,
	  138, 146, 139, 146,
	  123, 142, 146, 147,
  ...
  constexpr int BFLogmg[RANK_NB][int(FILE_NB) / 2] = {
      9,9,7,9,
      10,7,6,6,
      8,9,6,8,
      7,6,7,9,
  ...
  constexpr int BFLogeg[RANK_NB][int(FILE_NB) / 2] = {
      13,10,16,12,
      13,14,12,14,
      13,15,13,14,
      11,14,13,12,
