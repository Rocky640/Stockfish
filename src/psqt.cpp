...
Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   { S(-49,-58-15), S(- 7,-31), S(-10,-37), S(-34,-19) },
   { S(-24,-34), S(  9, -9-15), S( 15,-14), S(  1,  4) },
   { S( -9,-23), S( 22,  0), S( -3, -3-15), S( 12, 16) },
   { S(  4,-26), S(  9, -3), S( 18, -5), S( 40, 16) },
   { S( -8,-26), S( 27, -4), S( 13, -7), S( 30, 14) },
   { S(-17,-24), S( 14, -2), S( -6,  0-15), S(  6, 13) },
   { S(-19,-34), S(-13,-10-15), S(  7,-12), S(-11,  6) },
   { S(-47,-55-15), S( -7,-32), S(-17,-36), S(-29,-17) }
  },
  { // Rook
...
TUNE(SetRange(-100, 100), Bonus[BISHOP], init);
