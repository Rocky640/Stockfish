...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Queen
   { S( 3,-69), S(-5,-64), S(-5,-49), S( 4,-32) },
   { S(-3,-54), S( 5,-26), S( 8,-27), S(12, -3) },
   { S(-3,-39), S( 6,-20), S(13, -3), S( 7,  6) },
   { S( 4,-16), S( 5, -4), S( 9, 10), S( 8, 22) },
   { S( 0,-14), S(14,  9), S(12, 20), S( 5, 34) },
   { S(-4,-21), S(10, -6), S( 6,  0), S( 8, 15) },
   { S(-5,-37), S( 6, -8), S(10, -7), S( 8, 14) },
   { S(-2,-61), S(-2,-38), S( 1,-28), S(-2,-21) }
  },
  { // King
