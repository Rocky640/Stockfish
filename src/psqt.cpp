...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Knight
   { S(-165,-105), S(-102,-74), S(-80,-46), S(-77,-18) },
   { S( -80, -70), S( -35,-56), S(-30,-15), S( -17, 6) },
   { S( -54, -38), S( -14,-33), S(  7, -5), S( 23, 27) },
  ...
  { // Bishop
   { S(-54,-58), S( -4,-31), S(-12,-37), S(-32,-19) },
   { S(-16,-34), S( -1, -9), S( 20,-14), S( -4,  4) },
   { S(-11,-23), S( 23,  0), S( -9, -3), S( 14, 16) },
  ...
  { // Rook
   { S(-15, 0), S( -9, 0), S(  1, 5), S( 5, 5) },
   { S(-26, 0), S( -2, 0), S(-11, 0), S(-1, 0) },
   { S(-36, 0), S( 12, 0), S( -8, 0), S(-6, 0) },
  ...
  { // Queen
   { S( -2,-71), S( 4,-56), S(-9,-42), S(12,-29) },
   { S(  5,-56), S(11,-30), S( 9,-21), S(17, -5) },
   { S(-31,-39), S(-9,-17), S(18, -8), S(10,  5) },
  ...
  { // King
   { S(290,  0), S(353, 41), S(282, 80), S(190, 93) },
   { S(270, 57), S(296, 98), S(248,138), S(173,131) },
  ...
  { // Assymetric King, FILE_H to FILE_E, RANK_1 and RANK_2
   { S(274,  0), S(328, 41), S(272, 80), S(191, 93) },
   { S(281, 57), S(288, 98), S(234,138), S(181,131) }
  }
};
