...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Queen
   { S( -3,-63), S(-11,-63), S( 2,-45), S( 7,-32) },
   { S(  2,-52), S(  6,-27), S( 5,-18), S(12, -1) },
   { S(-24,-33), S(  0,-28), S(16,  2), S( 9,  1) },
   { S(-11,-25), S(  4, -2), S( 6, 12), S( 6, 20) },
   { S( -5,-23), S(  5, -3), S( 1, 13), S( 4, 20) },
   { S( -7,-40), S( 13,-11), S( 7,-19), S( 6,  5) },
   { S( -2,-61), S(  7,-30), S(-1,-18), S(13,  2) },
   { S(  7,-70), S( -2,-56), S(-7,-43), S( 2,-30) }
  },
  { // King
