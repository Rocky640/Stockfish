...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn (asymmetric distribution)
   { },
   { S(  2,-9), S( -5,-4), S(10, 7), S( 13, -1), S( 20,  6), S( 16,  8), S(  7, 0), S( -3,-20) },
   { S(-10,-7), S( -9,-7), S(13, 1), S( 22,  0), S( 25, -2), S( 28, -2), S(  4,-2), S(-25, -4) },
   { S(-10, 5), S(-18,-6), S( 8,-4), S( 20, -4), S( 34, -6), S( 25,-13), S( -5,-1), S(-16, -7) },
   { S(  8,17), S( -2, 2), S(-8, 1), S(  0,-11), S( 12,-12), S(  5, -9), S(-12,11), S( -2,  7) },
   { S( -6,25), S( -7,16), S( 7,19), S( 11, 29), S(-14, 30), S( -1,  8), S(-12, 3), S(-13, 13) },
   { S( -8, 1), S(  4,-4), S(-1,19), S( -9, 23), S( -3, 22), S(-14, 18), S( 11,-1), S(  0,  8) }
  };
