...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop 48221
   { S(-49,-80), S(- 7,-30), S(-10,-36), S(-34,-12) },
   { S(-24,-47), S(  9,-28), S( 15,-21), S(  1,  3) },
   { S( -9, -9), S( 22,  3), S( -3,-16), S( 12,  6) },
   { S(  4,-14), S(  9,-14), S( 18,  0), S( 40, 29) },
   { S( -8,-27), S( 27,  1), S( 13, -7), S( 30,  6) },
   { S(-17,-29), S( 14,-12), S( -6,-22), S(  6, 13) },
   { S(-19,-39), S(-13,-25), S(  7, -4), S(-11,  1) },
   { S(-47,-73), S( -7,-25), S(-17,-36), S(-29, -5) }
  },
  { // Rook
