...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Queen
   { S( -5,-66), S(-14,-49), S(  3,-58), S(21,-30) },
   { S( 24,-64), S( 30,-45), S( 27,-49), S(35, -4) },
   { S( -1,-63), S(  9,-13), S( 36,-14), S( 8, 11) },
   { S( -3,-20), S( 15,-26), S( 26,  7), S( 1, 41) },
   { S( 17,-44), S(  7,-16), S( -3,-10), S(10, 25) },
   { S(-11,-48), S(-11,-19), S( 32,-11), S(13, 10) },
   { S( -1,-42), S( 10,-37), S(  6,-31), S( 6,  7) },
   { S( -6,-49), S( -8,-60), S(-10,-32), S(41,-28) }
  },
  { // King
