...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S(- 6,10), S(  5,-4), S(  7, 8), S( 3,-2) },
   { S(-13,-1), S( -3,-5), S( 19, 5), S(24, 4) },
   { S(-12, 6), S(-10, 3), S( 16,-8), S(31,-3) },
   { S(- 1,11), S(  4, 9), S( -1, 7), S(17,-6) },
   { S(- 1,11), S(- 9,-5), S(-10, 2), S(-6, 4) },
   { S(  1, 6), S( 19,-9), S( -8, 1), S(-4,18) },
   { S(  0, 0), S(  0, 0), S(  0, 0), S( 0, 0) }
  },
  { // Knight
