...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop 32348
   { S(-49,-81), S(- 7,-31), S(-10,-38), S(-34,-10) },
   { S(-24,-44), S(  9,-26), S( 15,-16), S(  1,  3) },
   { S( -9,-11), S( 22,  0), S( -3,-18), S( 12, 10) },
   { S(  4,-19), S(  9,-12), S( 18, -4), S( 40, 28) },
   { S( -8,-25), S( 27,  6), S( 13, -9), S( 30,  8) },
   { S(-17,-28), S( 14, -8), S( -6,-22), S(  6, 11) },
   { S(-19,-39), S(-13,-19), S(  7, -3), S(-11,  0) },
   { S(-47,-73), S( -7,-30), S(-17,-35), S(-29, -6) }
  },
  { // Rook
