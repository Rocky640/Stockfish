...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn (asymmetric distribution)
   { },
   { S(  0,-10), S( -5,-3), S( 10, 7), S( 13,-1), S( 21,  7), S( 17,  6), S(  6, 1), S( -3,-20) },  //RANK 2
   ...
   { S( -6, 25+a), S( -8,17+a), S(  5,19+a), S( 11,29+a), S(-14, 29+a), S(  0,  8+a), S(-12, 4+a), S(-14, 12+a) },
   { S(-10, -1), S(  6,-6), S( -5,18), S(-11,22), S( -2, 22), S(-14, 17), S( 12, 2), S( -1,  9) }   //RANK 7
  };
