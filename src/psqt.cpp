...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop 57671
   { S(-49,-78), S(- 7,-28), S(-10,-34), S(-34,-13) },
   { S(-24,-50), S(  9,-28), S( 15,-19), S(  1,  5) },
   { S( -9, -7), S( 22,  4), S( -3,-18), S( 12,  6) },
   { S(  4,-12), S(  9,-12), S( 18, -1), S( 40, 28) },
   { S( -8,-29), S( 27, -1), S( 13, -5), S( 30,  7) },
   { S(-17,-32), S( 14,-15), S( -6,-22), S(  6, 12) },
   { S(-19,-40), S(-13,-22), S(  7, -3), S(-11,  3) },
   { S(-47,-75), S( -7,-27), S(-17,-37), S(-29, -7) }
  },
  { // Rook
