...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S(-11, -6), S(  7, -5), S(  7, 13), S(17,  2) },
   { S(-16,-10), S( -3, -3), S( 23, -6), S(23,  6) },
   { S(-14,  6), S( -7,  4), S( 20,-16), S(24, -5) },
   { S( -5,  9), S( -2, -2), S( -1, -3), S(12,-10) },
   { S(-11, 25), S(-12,  9), S( -2,  5), S( 4, 10) },
   { S( -2,-19), S( 20,-14), S(-10, -2), S(-2, 28) }
  },
  { // Knight
