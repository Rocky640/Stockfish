...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S(-10, -6), S( -1, -5), S( 0, 13), S(13,  2) },
   { S(-21,-10), S( -9, -3), S(22, -6), S(18,  6) },
   { S(-16,  6), S( -6,  4), S(16,-16), S(23, -5) },
   { S( -1,  9), S(  1, -2), S(-6, -3), S( 6,-10) },
   { S(-19, 25), S( -8,  9), S( 3,  5), S( 5, 10) },
   { S(  5,-19), S( 24,-14), S(-4, -2), S(-5, 28) }
  },
  { // Knight
